...
const EmployeeLeaveRequestForm = ({
  ...
  return (
    <div>
      <ModalContainer modal="createEmployeeLeaveRequest">
          ...
          <fieldset className="flex flex-col items-center p-4">
            ...
            <div className="relative w-full py-2">
              ...
              <Listbox
                ...
                onChange={(e) => setHeadOfficeApprover(e)}
            ...
            <div className="relative w-full py-2">
              ...
              <Listbox
                ...
                onChange={(e) => setWorkAssignment(e)}
              ...
              <fieldset className="w-full transition-transform">
                ...
                <div className="my-2 w-full">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      setCustomLeaveDays(parseInt(e.currentTarget.value));
                    }}
                  />
                </div>
              </fieldset>
