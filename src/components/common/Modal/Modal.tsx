...
const Modal = ({children, closeModal}: Props) => {
    ...
    const modalContainerClasses =
      "absolute py-8 flex flex-col top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-gray-50 dark:bg-gray-800 rounded-sm w-[calc(100vw-2rem)] md:w-1/2 max-w-5xl h-fit max-h-5xl";
    return (
        <FocusTrap>
            <div className=''>
