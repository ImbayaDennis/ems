...
const MetricsCard = ({
  ...
  return (
    <div className="h-1/3 my-4 flex w-full min-w-[24rem] max-w-2xl flex-col items-center justify-center rounded-lg bg-slate-300 p-4 shadow-md  dark:bg-slate-600">
