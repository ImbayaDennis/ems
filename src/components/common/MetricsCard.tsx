...
const MetricsCard = ({
  ...
  return (
    <div className="my-4 flex h-fit w-full min-w-[24rem] max-w-2xl flex-col items-center justify-center rounded-sm bg-slate-300 p-4 shadow-md dark:bg-slate-600  ">
