...
const MetricsCard = ({
  ...
  return (
    <div className="h-1/3 my-4 flex w-full min-w-[24rem] max-w-lg flex-col items-center justify-center rounded-lg bg-slate-300 p-4 shadow-md  dark:bg-slate-600 sm:w-2/5">
